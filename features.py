...
###########################################################      
    #for i in range(0,len(mpqaScores),step): 
        #es=eachLexiconScores(mpqaScores[i],tokens)
        #f.append(es)
...
##########################################        
    ...
    for i in range(0,len(mpqaScores),step):    
        #precision-objective
        average, minimum, maximum,differ,scs,std= LexiconScores(mpqaScores[i],tokens)
        f.append(average)
        f.append(minimum)
        f.append(maximum)
        f.append(differ)
        ...
        average, minimum, maximum,differ,scs,std= LexiconScores(mpqaScores[i+1],tokens)
        f.append(average)
        f.append(minimum)
        f.append(maximum)
        f.append(differ)
        ...
        #F1-objective
        average, minimum, maximum,differ,scs,std= LexiconScores(mpqaScores[i+2],tokens)
        f.append(average)
        f.append(minimum)
        f.append(maximum)
        f.append(differ)
        ...
        #F1-subjective
        average, minimum, maximum,differ,scs,std= LexiconScores(mpqaScores[i+3],tokens)
        f.append(average)
        f.append(minimum)
        f.append(maximum)
        f.append(differ)
        ...
        if pos_bigrams_scores_neutral is not None:
            #precision-neutral
            average, minimum, maximum,differ,scs,std= LexiconScores(mpqaScores[i+4],tokens)
            f.append(average)
            f.append(minimum)
            f.append(maximum)
            f.append(differ)
            ...
            #F1-neutral
            average, minimum, maximum,differ,scs,std= LexiconScores(mpqaScores[i+5],tokens)
            f.append(average)
            f.append(minimum)
            f.append(maximum)
            f.append(differ)
